...
abstract class AIPKit_Post_Enhancer_Base_Ajax_Action
{
    ...
    protected function check_permissions(string $nonce_action, string|array $module_slugs = []): bool|\WP_Error
    {
    ...
    protected function check_row_assistant_permissions(\WP_Post $post): bool|\WP_Error
    {
        return $this->check_post_utility_permission($post, self::ROW_ASSISTANT_MODULE);
    }

    protected function check_content_update_permissions(\WP_Post $post): bool|\WP_Error
    {
    ...
    protected function check_editor_context_permissions(): bool|\WP_Error
    {

...
function get_tts_config_logic(int $bot_id, callable $get_meta_fn): array {
    ...
    if (!class_exists(BotSettingsManager::class)) {
        ...
        else error_log("AIPKit Getter (TTS): BotSettingsManager class not found for constants.");
    }
    ...
    switch ($settings['tts_provider']) {
        case 'Google': $settings['tts_voice_id'] = $settings['tts_google_voice_id']; break;
        case 'OpenAI': $settings['tts_voice_id'] = $settings['tts_openai_voice_id']; break;
        case 'ElevenLabs': $settings['tts_voice_id'] = $settings['tts_elevenlabs_voice_id']; break;
    }

<?php
// File: classes/core/providers/xai/bootstrap-provider-strategy.php
...
class XAIProviderStrategy extends BaseProviderStrategy {
    ...
    public function generate_embeddings($input, array $api_params, array $options = []): array|WP_Error {
        return \WPAICG\Core\Providers\XAI\Methods\generate_embeddings_logic($this, $input, $api_params, $options);
    }

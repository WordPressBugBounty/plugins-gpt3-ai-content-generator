    ...
    private function localize_vpp_data(string $post_type): void
    {
        ...
        wp_localize_script('aipkit-admin-main', 'aipkit_vpp_config', [
            ...
            'text' => [
                ...
                'google_submission_complete' => __('Submitted to Google File Search', 'gpt3-ai-content-generator'),
                'google_submission_message' => __('Google is indexing this item in the background. Track completion in Sources.', 'gpt3-ai-content-generator'),

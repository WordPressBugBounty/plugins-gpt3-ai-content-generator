<?php
 if (!defined('ABSPATH')) { exit; } $notice_id = isset($notice_id) ? (string) $notice_id : ''; $notice_class = isset($notice_class) ? (string) $notice_class : ''; $aipkit_notice_id = isset($aipkit_notice_id) ? (string) $aipkit_notice_id : $notice_id; $aipkit_notice_class = isset($aipkit_notice_class) ? (string) $aipkit_notice_class : $notice_class; if ($aipkit_notice_id === '') { return; } $aipkit_settings_url = admin_url('admin.php?page=wpaicg'); ?>
<div

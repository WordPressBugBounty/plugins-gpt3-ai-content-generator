...
<div id="aipkit_task_cw_ai_parameters_row" style="display: none;">
    <div class="aipkit_form-row">
        ...
        <div class="aipkit_form-group aipkit_form-col">
            ...
            <div class="aipkit_slider_wrapper">
                <input type="range" id="aipkit_task_cw_content_max_tokens" name="content_max_tokens" class="aipkit_form-input aipkit_range_slider" min="100" max="4096" step="100" value="<?php echo esc_attr($cw_default_max_tokens); ?>">

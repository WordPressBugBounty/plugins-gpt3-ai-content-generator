...
<div id="aipkit_task_cw_input_modes_wrapper" class="aipkit_task_config_section" style="display: none;">
    ...
    <div id="aipkit_task_cw_input_mode_rss" class="aipkit_task_cw_input_mode_section" style="display:none;">
        <?php
 $rss_partial = WPAICG_PLUGIN_DIR . 'admin/views/modules/content-writer/partials/form-inputs/mode-rss.php'; if (file_exists($rss_partial)) { $aipkit_show_rss_fetch_button = true; include $rss_partial; unset($aipkit_show_rss_fetch_button); } else { echo '<p>This is a Pro feature. Please upgrade to access the RSS feature.</p>'; } ?>
    </div>

    <?php ?>
    <div id="aipkit_task_cw_input_mode_url" class="aipkit_task_cw_input_mode_section" style="display:none;">
        <?php
$url_partial = WPAICG_PLUGIN_DIR . 'admin/views/modules/content-writer/partials/form-inputs/mode-url.php'; if (file_exists($url_partial)) { include $url_partial; } else { echo '<p>This is a Pro feature. Please upgrade to access the URL feature.</p>'; } ?>
    </div>

    <?php ?>
    <div id="aipkit_task_cw_input_mode_gsheets" class="aipkit_task_cw_input_mode_section" style="display:none;">
        <?php
$gsheets_partial = WPAICG_PLUGIN_DIR . 'admin/views/modules/content-writer/partials/form-inputs/mode-gsheets.php'; if (file_exists($gsheets_partial)) { include $gsheets_partial; } else { echo '<p>This is a Pro feature. Please upgrade to access the Google Sheets feature.</p>'; } ?>
    </div>
</div>
<div id="aipkit_task_cc_source_wrapper" class="aipkit_task_config_section" style="display: none;">
    <?php
$comment_reply_source_partial = __DIR__ . '/community-engagement/source-settings.php'; if (file_exists($comment_reply_source_partial)) { include $comment_reply_source_partial; } else { echo '<p>Error: Comment Reply Source Settings UI partial is missing.</p>'; } ?>
</div>
<div id="aipkit_task_ce_content_selection_wrapper" class="aipkit_task_config_section" style="display: none;">
    <?php
 $content_enhancement_source_partial = __DIR__ . '/content-enhancement/source-settings.php'; if (file_exists($content_enhancement_source_partial)) { include $content_enhancement_source_partial; } else { echo '<p>Error: Content Enhancement Source Settings UI partial is missing.</p>'; } ?>
</div>

...
$default_meta_prompt = "Generate a single, concise, and SEO-friendly meta description (under 155 characters) for a web page based on the provided information. Include the key topic and make it engaging for search results. Return ONLY the new meta description without any introduction or formatting.\n\nPage title: \"{original_title}\"\nPage content snippet: \"{original_content}\"";
$default_content_prompt = "You are an expert editor. Rewrite and improve the following article content to make it more engaging, clear, and informative. Maintain the original tone and intent but enhance the writing quality. The article title is: {original_title}.\n\nOriginal Content:\n{original_content}";
    ...
    <div id="aipkit_task_ce_ai_parameters_row" style="display: none;">
        <div class="aipkit_form-row">
            ...
            <div class="aipkit_form-group aipkit_form-col">
                ...
                <div class="aipkit_slider_wrapper">
                    <input type="range" id="aipkit_task_ce_content_max_tokens" name="ce_content_max_tokens" class="aipkit_form-input aipkit_range_slider" min="100" max="4096" step="100" value="4000">

<?php
// File: admin/views/modules/chatbot/partials/appearance/custom-theme/input-area-settings.php
// NEW FILE

/**
 * Partial: Custom Theme - Input Area Color Settings
 */
if (!defined('ABSPATH')) {
    exit;
}
...
?>
<h5 style="margin-top:15px;"><?php esc_html_e('Input Area', 'gpt3-ai-content-generator'); ?></h5>

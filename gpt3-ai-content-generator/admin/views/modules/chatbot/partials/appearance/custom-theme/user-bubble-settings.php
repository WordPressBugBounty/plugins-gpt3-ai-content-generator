<?php
// File: admin/views/modules/chatbot/partials/appearance/custom-theme/user-bubble-settings.php
// NEW FILE

/**
 * Partial: Custom Theme - User Message Bubble Color Settings
 */
if (!defined('ABSPATH')) {
    exit;
}
...
?>
<h5 style="margin-top:15px;"><?php esc_html_e('User Messages', 'gpt3-ai-content-generator'); ?></h5>
<div class="aipkit_form-row">
    <div class="aipkit_form-group aipkit_form-col">
        <label class="aipkit_form-label" for="cts_user_bubble_bg_color_<?php echo esc_attr($bot_id); ?>">
    ...
    <div class="aipkit_form-group aipkit_form-col">
        <label class="aipkit_form-label" for="cts_user_bubble_text_color_<?php echo esc_attr($bot_id); ?>">

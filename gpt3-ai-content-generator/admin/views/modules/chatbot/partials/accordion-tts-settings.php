...
<div class="aipkit_accordion" data-section="tts-settings">
    <div class="aipkit_accordion-header">
        ...
        <?php esc_html_e('Voice Playback', 'gpt3-ai-content-generator'); ?>
    </div>
    <div class="aipkit_accordion-content">
        ...
        <div class="aipkit_form-row aipkit_checkbox-row">
            <div class="aipkit_form-group">
                ...
                >
                    ...
                    >
                    <?php esc_html_e('Enable Voice Playback', 'gpt3-ai-content-generator'); ?>
                </label>
                <div class="aipkit_form-help">
                    <?php esc_html_e('Add a play button to bot responses.', 'gpt3-ai-content-generator'); ?>
                </div>
            </div>

            <!-- Auto Play Checkbox (conditionally shown by JS) -->
            <div
        ...
        <!-- Container for settings shown only when TTS is enabled -->
        <div
            class="aipkit_tts_conditional_settings"
            id="aipkit_bot_<?php echo esc_attr($bot_id); ?>_tts_conditional"
            style="display: <?php echo $tts_enabled === '1' ? 'block' : 'none'; ?>; margin-top: 15px; padding-top: 15px; border-top: 1px dashed var(--aipkit_container-border);"
        >
            <div class="aipkit_form-row" style="align-items: flex-end; gap: 10px;">

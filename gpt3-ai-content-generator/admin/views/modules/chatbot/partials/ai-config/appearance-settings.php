            ...
            <div class="aipkit_interface_theme_top_row aipkit_interface_theme_top_row--primary">
                ...
                >
                    ...
                    <div
                        ...
                        data-placeholder="<?php echo esc_attr__('Position', 'gpt3-ai-content-generator'); ?>"
                    >
                        <button
                            type="button"
                        ...
                        >
                            <div class="aipkit_popover_multiselect_options aipkit_popup_launcher_options">
                                ...
                                <div class="aipkit_popup_launcher_row aipkit_popup_launcher_row--style">
                                    <p class="aipkit_popup_launcher_row_label"><?php esc_html_e('Style', 'gpt3-ai-content-generator'); ?></p>
                                    <div class="aipkit_popup_launcher_row_controls aipkit_popup_launcher_row_controls--radios" role="group" aria-label="<?php echo esc_attr__('Style', 'gpt3-ai-content-generator'); ?>">
                                        <label class="aipkit_popover_multiselect_item aipkit_popup_launcher_item">
                                ...
                                <div class="aipkit_popup_launcher_row aipkit_popup_launcher_row--size">
                                    <p class="aipkit_popup_launcher_row_label"><?php esc_html_e('Size', 'gpt3-ai-content-generator'); ?></p>
                                    <div class="aipkit_popup_launcher_row_controls aipkit_popup_launcher_row_controls--radios" role="group" aria-label="<?php echo esc_attr__('Size', 'gpt3-ai-content-generator'); ?>">
                                        <label class="aipkit_popover_multiselect_item aipkit_popup_launcher_item">
                                ...
                                <div class="aipkit_popup_launcher_row aipkit_popup_launcher_row--delay">
                                    <p class="aipkit_popup_launcher_row_label"><?php esc_html_e('Delay', 'gpt3-ai-content-generator'); ?></p>
                                    <div class="aipkit_popup_launcher_row_controls aipkit_popup_launcher_row_controls--delay aipkit_popup_launcher_delay_field">
                                        <input
                                            type="number"
                                            ...
                                            step="1"
                                        />
                                        <span class="aipkit_popup_launcher_delay_suffix"><?php esc_html_e('sec', 'gpt3-ai-content-generator'); ?></span>
                                    </div>
                                </div>
                                <div class="aipkit_popup_launcher_row aipkit_popup_launcher_row--hint">
                                    <p class="aipkit_popup_launcher_row_label"><?php esc_html_e('Hint', 'gpt3-ai-content-generator'); ?></p>
                                    <div class="aipkit_popup_launcher_row_controls aipkit_popup_launcher_row_controls--hint aipkit_popup_launcher_item--hint">
                                        <label class="aipkit_popup_launcher_item_main" for="aipkit_bot_<?php echo esc_attr($bot_id); ?>_popup_label_enabled_launcher">
                                            ...
                                            />
                                            <span class="aipkit_popover_multiselect_text"><?php esc_html_e('Enable', 'gpt3-ai-content-generator'); ?></span>
                                        </label>
                                        <button
                                            type="button"

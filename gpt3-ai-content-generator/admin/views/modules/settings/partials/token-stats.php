...
<div class="aipkit_settings_column aipkit_settings_column-right aipkit_sub_container">
    ...
    <div class="aipkit_sub_container_body">
        ...
        <?php else: ?>
            <p class="aipkit_form-help" style="margin-bottom: 15px;">
                <?php
            ...
            <div class="aipkit_stats_overview_grid">
                ...
                <div class="aipkit_stats_overview_card">
                    ...
                    <div class="aipkit_stats_overview_value"><?php echo esc_html(number_format_i18n($total_tokens_used)); ?></div>
                ...
                <div class="aipkit_stats_overview_card">
                    ...
                    <div class="aipkit_stats_overview_value"><?php echo esc_html(number_format_i18n($avg_tokens_per_interaction)); ?></div>
                     <div class="aipkit_stats_overview_details"><?php esc_html_e('(Estimate)', 'gpt3-ai-content-generator'); ?></div>
                </div>
            ...
            <!-- Chart Container -->
            <div id="aipkit_token_usage_chart_container" class="aipkit_token_usage_chart_container">

<?php
 if (!defined('ABSPATH')) { exit; } $is_pro_plan = class_exists('\WPAICG\\aipkit_dashboard') && \WPAICG\aipkit_dashboard::is_pro_plan(); $upgrade_url = function_exists('wpaicg_gacg_fs') ? wpaicg_gacg_fs()->get_upgrade_url() : admin_url('admin.php?page=wpaicg-pricing'); $apps_logo_base_url = defined('WPAICG_PLUGIN_URL') ? WPAICG_PLUGIN_URL . 'admin/images/apps/' : ''; $supported_apps_for_upsell = [ [ 'name' => __('Slack', 'gpt3-ai-content-generator'), 'summary' => __('Slack alerts and team notifications.', 'gpt3-ai-content-generator'), 'logo_url' => $apps_logo_base_url . 'slack.svg', ], [ 'name' => __('HubSpot', 'gpt3-ai-content-generator'), 'summary' => __('HubSpot contacts and CRM handoff.', 'gpt3-ai-content-generator'), 'logo_url' => $apps_logo_base_url . 'hubspot.svg', ], [ 'name' => __('Notion', 'gpt3-ai-content-generator'), 'summary' => __('Notion pages and database items.', 'gpt3-ai-content-generator'), 'logo_url' => $apps_logo_base_url . 'notion.svg', ], [ 'name' => __('Pipedrive', 'gpt3-ai-content-generator'), 'summary' => __('Pipedrive people and pipeline-ready leads.', 'gpt3-ai-content-generator'), 'logo_url' => $apps_logo_base_url . 'pipedrive.svg', ], [ 'name' => __('Zapier', 'gpt3-ai-content-generator'), 'summary' => __('Zapier webhook-based automation flows.', 'gpt3-ai-content-generator'), 'logo_url' => $apps_logo_base_url . 'zapier.svg', ], [ 'name' => __('Make', 'gpt3-ai-content-generator'), 'summary' => __('Make scenarios triggered by events.', 'gpt3-ai-content-generator'), 'logo_url' => $apps_logo_base_url . 'make.svg', ], [ 'name' => __('n8n', 'gpt3-ai-content-generator'), 'summary' => __('n8n webhook workflows.', 'gpt3-ai-content-generator'), 'logo_url' => $apps_logo_base_url . 'n8n.svg', ], ]; $supported_modules_for_upsell = [ __('AI Forms', 'gpt3-ai-content-generator'), __('Content Writer', 'gpt3-ai-content-generator'), __('Task Automation', 'gpt3-ai-content-generator'), __('Image Generator', 'gpt3-ai-content-generator'), __('Knowledge Base', 'gpt3-ai-content-generator'), __('Chatbot', 'gpt3-ai-content-generator'), ]; if (!$is_pro_plan) : ?>
...
<?php
 include __DIR__ . '/settings-app-connections.php'; include __DIR__ . '/settings-recipes.php'; include __DIR__ . '/settings-app-delivery-issues.php'; 
...
?>
<div class="aipkit_rss_import_container aipkit_cw_source_mode_shell aipkit_cw_source_mode_shell--rss" data-rss-container>
    <div class="aipkit_cw_source_mode_header">
        <h3 class="aipkit_cw_source_mode_title"><?php esc_html_e('Import from RSS feeds', 'gpt3-ai-content-generator'); ?></h3>
        <p class="aipkit_cw_source_mode_desc"><?php esc_html_e('Add one feed URL per line, then filter titles before you fetch items into the writer.', 'gpt3-ai-content-generator'); ?></p>
    </div>
    ...
    <div class="aipkit_cw_source_mode_stage">
        ...
        <div class="aipkit_rss_filters_grid">
            <div class="aipkit_rss_filter_card aipkit_rss_filter_card--include">
                ...
                >
                <span class="aipkit_rss_filter_hint"><?php esc_html_e('Only fetch titles containing these terms.', 'gpt3-ai-content-generator'); ?></span>
            </div>
            ...
            <div class="aipkit_rss_filter_card aipkit_rss_filter_card--exclude">
                ...
                >
                <span class="aipkit_rss_filter_hint"><?php esc_html_e('Skip titles containing these terms.', 'gpt3-ai-content-generator'); ?></span>
            </div>
        </div>

        ...
        <div class="aipkit_model_settings_popover_body aipkit_cw_settings_popover_body aipkit_cw_settings_sheet_body">
            <div class="aipkit_popover_options_list">
                ...
                <div id="aipkit_cw_image_provider_options_block" hidden>
                    <div id="aipkit_cw_openai_options" data-aipkit-image-provider-options="openai" hidden>
                        <div class="aipkit_popover_option_row">
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_openai_canvas_size"><?php esc_html_e('Canvas size', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Generated image dimensions.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_openai_canvas_size" name="openai_canvas_size" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="canvas_size">
                        ...
                        <div class="aipkit_popover_option_row">
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_openai_quality"><?php esc_html_e('Quality', 'gpt3-ai-content-generator'); ?></label>
                                ...
                                <select id="aipkit_cw_openai_quality" name="openai_quality" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="quality">
                        ...
                        <div class="aipkit_popover_option_row">
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_openai_output_format"><?php esc_html_e('Output format', 'gpt3-ai-content-generator'); ?></label>
                                ...
                                <select id="aipkit_cw_openai_output_format" name="openai_output_format" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="output_format">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                        ...
                        <div class="aipkit_popover_option_row" data-aipkit-openai-compression-row hidden>
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_openai_output_compression"><?php esc_html_e('Compression', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Only used for JPEG or WebP output.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_openai_output_compression" name="openai_output_compression" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="output_compression">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                        ...
                        <div class="aipkit_popover_option_row">
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_openai_background"><?php esc_html_e('Background', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Sets image background.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_openai_background" name="openai_background" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="background">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="auto"><?php esc_html_e('Auto', 'gpt3-ai-content-generator'); ?></option>
                        ...
                        <div class="aipkit_popover_option_row">
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_openai_moderation"><?php esc_html_e('Moderation', 'gpt3-ai-content-generator'); ?></label>
                                ...
                                <select id="aipkit_cw_openai_moderation" name="openai_moderation" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="moderation">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="auto"><?php esc_html_e('Auto', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="low"><?php esc_html_e('Low', 'gpt3-ai-content-generator'); ?></option>
                                </select>
                    ...
                    <div id="aipkit_cw_azure_options" data-aipkit-image-provider-options="azure" hidden>
                        <div class="aipkit_popover_option_row">
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_azure_canvas_size"><?php esc_html_e('Canvas size', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Generated image dimensions.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_azure_canvas_size" name="azure_canvas_size" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="canvas_size">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                        ...
                        <div class="aipkit_popover_option_row">
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_azure_quality"><?php esc_html_e('Quality', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Controls generation cost and detail.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_azure_quality" name="azure_quality" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="quality">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="low"><?php esc_html_e('Low', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="medium"><?php esc_html_e('Medium', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="high"><?php esc_html_e('High', 'gpt3-ai-content-generator'); ?></option>
                        ...
                        <div class="aipkit_popover_option_row">
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_azure_output_format"><?php esc_html_e('Output format', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Saved file format for generated images.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_azure_output_format" name="azure_output_format" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="output_format">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="png">PNG</option>
                                    <option value="jpeg">JPEG</option>
                                </select>
                        ...
                        <div class="aipkit_popover_option_row" data-aipkit-azure-compression-row hidden>
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_azure_output_compression"><?php esc_html_e('Compression', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Only used for JPEG output.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_azure_output_compression" name="azure_output_compression" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="output_compression">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="25">25%</option>
                                    <option value="50">50%</option>
                                    <option value="75">75%</option>
                        ...
                        <div class="aipkit_popover_option_row">
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_azure_background"><?php esc_html_e('Background', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Transparent output is saved as PNG.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_azure_background" name="azure_background" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="background">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="auto"><?php esc_html_e('Auto', 'gpt3-ai-content-generator'); ?></option>
                    ...
                    <div id="aipkit_cw_google_options" data-aipkit-image-provider-options="google" hidden>
                        <div class="aipkit_popover_option_row" data-aipkit-google-aspect-ratio-row hidden>
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_google_aspect_ratio"><?php esc_html_e('Aspect ratio', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Generated image shape.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_google_aspect_ratio" name="google_aspect_ratio" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="aspect_ratio">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                        ...
                        <div class="aipkit_popover_option_row" data-aipkit-google-image-size-row hidden>
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_google_image_size"><?php esc_html_e('Image size', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Provider output resolution.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_google_image_size" name="google_image_size" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="image_size">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                        ...
                        <div class="aipkit_popover_option_row" data-aipkit-google-person-generation-row hidden>
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_google_person_generation"><?php esc_html_e('People', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Imagen person generation policy.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_google_person_generation" name="google_person_generation" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="person_generation">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                    ...
                    <div id="aipkit_cw_openrouter_options" data-aipkit-image-provider-options="openrouter" hidden>
                        <div class="aipkit_popover_option_row" data-aipkit-openrouter-aspect-ratio-row hidden>
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_openrouter_aspect_ratio"><?php esc_html_e('Aspect ratio', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Model-dependent image_config shape.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_openrouter_aspect_ratio" name="openrouter_aspect_ratio" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="aspect_ratio">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="1:1"><?php esc_html_e('Square', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="2:3">2:3</option>
                                    <option value="3:2">3:2</option>
                        ...
                        <div class="aipkit_popover_option_row" data-aipkit-openrouter-image-size-row hidden>
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_openrouter_image_size"><?php esc_html_e('Image size', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Provider output resolution.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_openrouter_image_size" name="openrouter_image_size" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="image_size">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="1k">1K</option>
                                    <option value="2k">2K</option>
                                    <option value="4k">4K</option>
                    ...
                    <div id="aipkit_cw_xai_options" data-aipkit-image-provider-options="xai" hidden>
                        <div class="aipkit_popover_option_row">
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_xai_aspect_ratio"><?php esc_html_e('Aspect ratio', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Generated image shape.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_xai_aspect_ratio" name="xai_aspect_ratio" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="aspect_ratio">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="auto"><?php esc_html_e('Auto', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="1:1"><?php esc_html_e('Square', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="16:9"><?php esc_html_e('Wide 16:9', 'gpt3-ai-content-generator'); ?></option>
                        ...
                        <div class="aipkit_popover_option_row">
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_xai_resolution"><?php esc_html_e('Resolution', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Provider output resolution.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_xai_resolution" name="xai_resolution" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="resolution">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="1k">1K</option>
                                    <option value="2k">2K</option>
                                </select>
                    ...
                    <div id="aipkit_cw_replicate_options" data-aipkit-image-provider-options="replicate" hidden>
                        <div class="aipkit_popover_option_row" data-aipkit-replicate-option-row="aspect_ratio" hidden>
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_replicate_aspect_ratio"><?php esc_html_e('Aspect ratio', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Generated image shape.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_replicate_aspect_ratio" name="replicate_aspect_ratio" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="aspect_ratio">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="1:1"><?php esc_html_e('Square', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="16:9"><?php esc_html_e('Wide 16:9', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="21:9">21:9</option>
                        ...
                        <div class="aipkit_popover_option_row" data-aipkit-replicate-option-row="width" hidden>
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_replicate_width"><?php esc_html_e('Width', 'gpt3-ai-content-generator'); ?></label>
                                ...
                                <input type="number" id="aipkit_cw_replicate_width" name="replicate_width" min="64" max="4096" step="1" class="aipkit_form-input aipkit_autosave_trigger aipkit_popover_option_input aipkit_popover_option_input--compact" data-aipkit-image-provider-option="width" />
                            </div>
                        </div>
                        ...
                        <div class="aipkit_popover_option_row" data-aipkit-replicate-option-row="height" hidden>
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_replicate_height"><?php esc_html_e('Height', 'gpt3-ai-content-generator'); ?></label>
                                ...
                                <input type="number" id="aipkit_cw_replicate_height" name="replicate_height" min="64" max="4096" step="1" class="aipkit_form-input aipkit_autosave_trigger aipkit_popover_option_input aipkit_popover_option_input--compact" data-aipkit-image-provider-option="height" />
                            </div>
                        </div>
                        ...
                        <div class="aipkit_popover_option_row" data-aipkit-replicate-option-row="negative_prompt" hidden>
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_replicate_negative_prompt"><?php esc_html_e('Negative prompt', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('What the model should avoid.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <input type="text" id="aipkit_cw_replicate_negative_prompt" name="replicate_negative_prompt" maxlength="1000" class="aipkit_form-input aipkit_autosave_trigger aipkit_popover_option_input" data-aipkit-image-provider-option="negative_prompt" />
                            </div>
                        </div>
                        ...
                        <div class="aipkit_popover_option_row" data-aipkit-replicate-option-row="guidance" hidden>
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_replicate_guidance"><?php esc_html_e('Guidance', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Prompt adherence strength.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <input type="number" id="aipkit_cw_replicate_guidance" name="replicate_guidance" min="0" max="30" step="0.1" class="aipkit_form-input aipkit_autosave_trigger aipkit_popover_option_input aipkit_popover_option_input--compact" data-aipkit-image-provider-option="guidance" />
                            </div>
                        </div>
                        ...
                        <div class="aipkit_popover_option_row" data-aipkit-replicate-option-row="num_inference_steps" hidden>
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_replicate_num_inference_steps"><?php esc_html_e('Steps', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Inference steps when supported.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <input type="number" id="aipkit_cw_replicate_num_inference_steps" name="replicate_num_inference_steps" min="1" max="100" step="1" class="aipkit_form-input aipkit_autosave_trigger aipkit_popover_option_input aipkit_popover_option_input--compact" data-aipkit-image-provider-option="num_inference_steps" />
                            </div>
                        </div>
                        ...
                        <div class="aipkit_popover_option_row" data-aipkit-replicate-option-row="seed" hidden>
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_replicate_seed"><?php esc_html_e('Seed', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Repeatable generation seed.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <input type="number" id="aipkit_cw_replicate_seed" name="replicate_seed" min="0" max="2147483647" step="1" class="aipkit_form-input aipkit_autosave_trigger aipkit_popover_option_input aipkit_popover_option_input--compact" data-aipkit-image-provider-option="seed" />
                            </div>
                        </div>
                        ...
                        <div class="aipkit_popover_option_row" data-aipkit-replicate-option-row="output_format" hidden>
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_replicate_output_format"><?php esc_html_e('Output format', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Saved file format when supported.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <select id="aipkit_cw_replicate_output_format" name="replicate_output_format" class="aipkit_autosave_trigger aipkit_popover_option_select aipkit_popover_option_select--fit aipkit_cw_blended_chevron_select" data-aipkit-image-provider-option="output_format">
                                    <option value="" selected><?php esc_html_e('Default', 'gpt3-ai-content-generator'); ?></option>
                                    <option value="webp">WebP</option>
                                    <option value="png">PNG</option>
                        ...
                        <div class="aipkit_popover_option_row" data-aipkit-replicate-option-row="output_quality" hidden>
                            <div class="aipkit_popover_option_main">
                                <div class="aipkit_cw_settings_option_text">
                                    <label class="aipkit_popover_option_label" for="aipkit_cw_replicate_output_quality"><?php esc_html_e('Quality', 'gpt3-ai-content-generator'); ?></label>
                                    <span class="aipkit_popover_option_helper"><?php esc_html_e('Output compression quality.', 'gpt3-ai-content-generator'); ?></span>
                                </div>
                                <input type="number" id="aipkit_cw_replicate_output_quality" name="replicate_output_quality" min="0" max="100" step="1" class="aipkit_form-input aipkit_autosave_trigger aipkit_popover_option_input aipkit_popover_option_input--compact" data-aipkit-image-provider-option="output_quality" />
                            </div>
                        </div>
                    </div>
